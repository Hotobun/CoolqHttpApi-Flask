...
coolq_bp = Blueprint('coolq',__name__,url_prefix='/coolq') 
...
def hellocoolq():
    return abort(404) 
    # return "coolq sdk addr --> {}".format(request.remote_addr)
...
class OriginCQHttp:
    ...
    def _handle(self):
        # if request.remote_addr != '172.18.0.2':
        #     print("addr error !", request.remote_addr)
        #     return abort(404)
        if self._secret:
